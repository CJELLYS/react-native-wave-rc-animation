...
- (void)setWidth:(CGFloat)width{
  [self setFrame:CGRectMake(0, 0, width, self.frame.size.height)];
}
...
- (void)setUp
{
  waterWaveHeight = self.frame.size.height/2;
  waterWaveWidth  = self.frame.size.width;
  _behindWaveColor = [UIColor colorWithRed:223/255.0 green:83/255.0 blue:64/255.0 alpha:1];
  _frontWaveColor = [UIColor colorWithRed:236/255.0f green:90/255.0f blue:66/255.0f alpha:1];
...
- (void)setBehindWaveColor:(UIColor *)behindWaveColor
{
  ...
  _firstWaveLayer.fillColor = behindWaveColor.CGColor;
}

- (void)setFrontWaveColor:(UIColor *)frontWaveColor
{
  _frontWaveColor = frontWaveColor;
  _secondWaveLayer.fillColor = frontWaveColor.CGColor;
}
...
-(void)startWave
{
  ...
  if (_firstWaveLayer == nil) {
    ...
    _firstWaveLayer.fillColor = _behindWaveColor.CGColor;
  ...
  if (_secondWaveLayer == nil) {
    ...
    _secondWaveLayer.fillColor = _frontWaveColor.CGColor;
